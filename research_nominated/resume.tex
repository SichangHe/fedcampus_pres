...
\CVItemListStart
\CVItem
{Led and managed The FedCampus Team and its systems development for the
    FedCampus Android/iOS app,
    leveraging personal health data from over 100 participants to conduct
    real-world FL and federated analytics experiments on DKU campus.
    \begin{itemize}
        \item Supervised and mentored four DKU undergrads and
              one DKU M. Eng. student in mobile and web development.
        \item Interviewed and recruited five DKU undergrads---a UI programmer,
            a designer, two systems programmers,
              and a data scientist---and introduced them to FL, web development,
...
\CVItem
{Co-interviewed and recruited three DKU undergrads to join the team,
    including two systems programmers and a manager.
}
\CVItem
{Improved backend HTML processing, beautified the frontend,
    and consolidated team collaboration with Git.
}
\CVItemListEnd
\CVSubHeadingListEnd
